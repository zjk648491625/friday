// Friday AI Rebrand Script - extensions/vscode
import { readFileSync, writeFileSync, readdirSync, statSync } from 'fs';
import { join, extname, relative } from 'path';

const TARGET = 'd:/Microservice/friday/extensions/vscode';
const SKIP_DIRS = ['node_modules', '.git', 'dist', 'build', 'out', '.vscode-test'];
