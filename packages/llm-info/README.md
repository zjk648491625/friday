...
Whereas @friday-ai/openai-adapters is responsible for translation between API types, @friday-ai/llm-info is concerned with
...
We know we are done when the steps required to add support for a new model in Friday are exactly
