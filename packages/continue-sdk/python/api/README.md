...
API for Friday IDE to fetch assistants and other related information.
These endpoints are primarily used by the Friday IDE extensions for VS Code and JetBrains.
...
- Build package: org.openapitools.codegen.languages.PythonClientCodegen
  For more information, please visit [https://friday.dev](https://friday.dev)
