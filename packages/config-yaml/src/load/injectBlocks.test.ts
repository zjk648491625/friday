...
schema: v1
rules:
  - "Input: \${{ inputs.userSetting }} | Secret: \${{ secrets.apiKey }} | Friday: \${{ friday.workspaceRoot }}"
`;
    ...
    expect(ruleText).toBe(
      "Input: ${{ secrets.//userSetting }} | Secret: ${{ secrets.//apiKey }} | Friday: ${{ friday.workspaceRoot }}",
    );
    ...
    expect(configStr).toContain("friday.workspaceRoot");
  });
