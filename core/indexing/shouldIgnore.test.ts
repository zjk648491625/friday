...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .fridayignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".fridayignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .fridayignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".fridayignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.fridayignore", "level3/"],
    ]);
    const result = await shouldIgnore(
