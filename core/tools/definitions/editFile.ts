...
export const NO_PARALLEL_TOOL_CALLING_INSTRUCTION =
  "Cannot be called in parallel with other tools";
...
export const editFileTool: Tool = {
  ...
  function: {
    ...
    description: `Edit an existing file. If you don't know the file contents, read it first. ${CHANGES_DESCRIPTION}. ${NO_PARALLEL_TOOL_CALLING_INSTRUCTION}.`,
    parameters: {
      type: "object",
