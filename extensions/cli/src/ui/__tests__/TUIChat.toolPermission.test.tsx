...
describe("TUIChat - Tool Permission Tests", () => {
  ...
  it("handles arrow key navigation in permission selector", async () => {
    ...
    // Initial state should show "> Friday" selected
    const frame = lastFrame();
    expect(frame).toMatch(/>\s+Friday/);
  ...
  it("shows the new 'No, and tell Friday what to do differently' option in the UI", async () => {
    const handleResponse = vi.fn();
  ...
  it("triggers stop stream when escape key is pressed", async () => {
    ...
    // Press escape key to trigger the "No, and tell Friday what to do differently" option
    stdin.write("\x1b"); // ESC key
  ...
  it("triggers stop stream when 'n' key is pressed", async () => {
    ...
    // Press 'n' key to trigger the "No, and tell Friday what to do differently" option
    stdin.write("n");
