...
models:
  - model: gpt-4
    ...
    expect(output).toContain('friday -p "please review my current git diff"');
    expect(output).toContain('echo "hello" | friday -p');
    expect(output).toContain('friday -p "analyze the code in src/"');
  });
